        ...
        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
          <div class="relative" data-aos="fade-up" data-aos-delay="100">
            ...
            <dd class="mt-2 ml-16 text-base text-gray-500">
              내 공장에 필요한 기계, 설비, 공구 필요하시죠? 앱으로 간편하게, 채팅으로 뚝딱! 산업 기계 직거래 서비스, 산업마켓
            </dd>
          </div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-delay="100">
            ...
            <dd class="mt-2 ml-16 text-base text-gray-500">
              잠자는 내 설비, 기계, 공구 아까우셨죠? 글로벌 직거래 장터! 비용 걱정도 No! 이제는? 산업마켓하세요.
            </dd>
          </div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-delay="100">
            ...
            <dd class="mt-2 ml-16 text-base text-gray-500">
            이걸 또 누가 쓰지? 먼지만 쌓여가는 유휴 제품, 이제는 빛날 차례! 걱정 말고, 산업마켓에서 나눔하세요. 
            </dd>
          </div>
        </dl>
      </div>
