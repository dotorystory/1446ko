  ...
  <div class="xl:px-40 pb-12 lg:px-20 md:px-10 sm:px-5 px-10">
    <div class="w-full pt-12 flex flex-col sm:flex-row space-y-2  justify-start">
      ...
      <div class="w-full sm:w-1/5 flex-1 sm:flex flex-col space-y-4">
        ...
        <a href="<?php echo G5_URL ?>/#new-idea" class="opacity-60 w-1/2">앱 다운로드</a>
      </div>
      <div class="w-full sm:w-1/5 flex-1 sm:flex flex-col space-y-4">
        ...
        <a href="<?php echo G5_BBS_URL ?>/faq.php" class="opacity-60 w-1/2 sm:w-full inline-flex">광고 안내</a>
        <!-- <a href="#testimonials" class="opacity-60 w-1/2 sm:w-full inline-flex">광고 안내</a> -->
        <a href="<?php echo G5_URL ?>/qa" class="opacity-60 w-1/2 sm:w-full">온라인 상담</a>
