...
<div class="swiper-slide text-center text-base">
          <div class="testimonial-item text-center text-white">
            <h3 class="text-2xl font-bold mt-2 text-white">광고 신청 절차</h3>
            <div class="mt-4">
              <img src="<?php echo G5_THEME_IMG_URL ?>/ad_process.jpg" alt="광고 신청 절차" class="mx-auto cursor-pointer" onclick="openVideoModal()">
            </div>
            <p class="text-lg mt-4 text-gray-300">이미지를 클릭하면 상세 영상을 볼 수 있습니다.</p>
          </div>
        </div><!-- End Slide 4 -->
        ...
        <div id="videoModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
          <div class="bg-white p-4 rounded-lg">
            <div class="relative" style="padding-top: 56.25%;">
              <iframe id="videoFrame" class="absolute inset-0 w-full h-full" src="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
            <button onclick="closeVideoModal()" class="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">닫기</button>
          </div>
        </div>
        ...
        function openVideoModal() {
          ...
          document.getElementById('videoFrame').src = 'https://www.youtube.com/embed/YOUR_VIDEO_ID';
        }
